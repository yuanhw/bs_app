...
public class TabPlantFragment1 extends Fragment {
    private List<SelfBDetail> data = new ArrayList<>();
    private TabSelfAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new TabSelfAdapter(this.getActivity(), data);
    ...
    private void loadData() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                data.clear();
                data.addAll(datas);
                TabPlantFragment1.this.getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
