...
public class CaiFragment3 extends Fragment {
    private CaiAdapter3 adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new CaiAdapter3(this.getActivity(), data);
    ...
    private void loadData() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                data.clear();
                data.addAll(datas);
                CaiFragment3.this.getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
