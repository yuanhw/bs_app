...
import cn.wyh.bs.R;
import cn.wyh.bs.adapter.CaiAdapter3;
import cn.wyh.bs.adapter.CaiAdapter4;
...
public class CaiFragment4 extends Fragment {
    private CaiAdapter4 adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new CaiAdapter4(this.getActivity(), data);
    ...
    private void loadData() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                data.clear();
                data.addAll(datas);
                CaiFragment4.this.getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
