...
public class TabOrderFragment4 extends Fragment {
    private RecyclerView rv;
    private List<TabAllOrder> data = new ArrayList<>();
    private TabAllAdapter4 adapter;
    private View show;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.o_all_f4, container, false);
        rv = (RecyclerView) view.findViewById(R.id.o_rv_4);
        show = view.findViewById(R.id.showTip4);
        adapter = new TabAllAdapter4(this.getContext(), data);
