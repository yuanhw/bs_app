...
public class TabStatusFragment1 extends Fragment {
    private List<BlockPlantDto> data = new ArrayList<>();
    private TabPlantOneAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new TabPlantOneAdapter(this.getActivity(), data);
    ...
    private void loadData() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                data.clear();
                data.addAll(datas);
                TabStatusFragment1.this.getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
