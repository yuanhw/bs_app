...
public class CaiFragment1 extends Fragment {
    private CaiAdapter1 adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new CaiAdapter1(this.getActivity(), data);
    ...
    private void loadData() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                data.clear();
                data.addAll(datas);
                CaiFragment1.this.getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
