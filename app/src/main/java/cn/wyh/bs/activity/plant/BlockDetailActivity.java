...
public class BlockDetailActivity extends FragmentActivity {
    @Override
    ...
    private void initTab() {
        Tab tab_self = new Tab("one", "自种", 0, TabPlantFragment1.class);
        Tab tab_other = new Tab("two", "代种", 0, TabPlantFragment2.class);
