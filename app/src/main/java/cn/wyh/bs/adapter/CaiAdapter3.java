...
public class CaiAdapter3 extends RecyclerView.Adapter<CaiAdapter3.ViewHolder> {
    private Activity context;
    private List<CaiOneDto> data;

    public CaiAdapter3(Activity context, List<CaiOneDto> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cai_3_item, parent, false);
                ...
                dialog.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        new Thread(new Runnable() {
                            @Override
                            public void run() {
                                String resp = Global.httpPost3("/cai//web/updateStatus.do", "id=" + caiId + "&status=3");
                                ...
                                if (i == 1) {
                                    ...
                                    context.runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            AlertDialog.Builder dialog = new AlertDialog.Builder(context);
                                            dialog.setMessage("已确认");
                                            dialog.show();
                                            CaiAdapter3.this.notifyDataSetChanged();
                                        }
                                    });
                                }
                            }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tv6.setText("发货时间：" + Global.convertDate(order.getSendTime(), Const.DATE_TIME_FORMAT));
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            bt = (Button) itemView.findViewById(R.id.ok);
        }
    }
}
