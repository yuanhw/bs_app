...
public class CaiAdapter2 extends RecyclerView.Adapter<CaiAdapter2.ViewHolder> {
    private Activity context;
    private List<CaiOneDto> data;

    public CaiAdapter2(Activity context, List<CaiOneDto> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cai_2_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tv6.setText("受理时间：" + Global.convertDate(order.getUpdateTIme(), Const.DATE_TIME_FORMAT));
        holder.tv7.setText("负责人：" + order.getOperate());
        holder.tv8.setText("手机号：" + order.getPhone());
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ImageView caiImg;
        TextView tv1, tv2, tv3, tv4, tv6, tv7, tv8;
