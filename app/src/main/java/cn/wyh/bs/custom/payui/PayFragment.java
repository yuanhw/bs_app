package cn.wyh.bs.custom.payui;
...
public class PayFragment extends DialogFragment implements View.OnClickListener {
    ...
    private void initView(Dialog dialog) {
        ...
        showError = (TextView) dialog.findViewById(R.id.show_error);
        psw_input.setShowError(showError);
    ...
    public void showError(boolean isShow, String text) {
        if (this.showError != null) {
            if (isShow) {
                this.showError.setText(text);
                this.showError.setVisibility(View.VISIBLE);
            } else {
                this.showError.setVisibility(View.GONE);
            }
        }
    }
}
